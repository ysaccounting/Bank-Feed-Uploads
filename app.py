...
# Reset handler
def reset():
    for key in ["broker", "platform", "start_date", "end_date", "output_mode", "rows_per_file", "uploader"]:
...
st.divider()
uploaded_file = st.file_uploader("Source file", type=["csv", "xlsx"], key="uploader")
